    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trans_type', models.CharField(choices=[(b'deposit', 'deposit'), (b'withdraw', 'withdraw')], default=b'deposit', max_length=32, verbose_name='drawer trans type')),
                ('amount', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=100, verbose_name='total cost')),
                ('created', models.DateTimeField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
            ],
            options={
                'verbose_name': 'DrawerCash',
                'verbose_name_plural': 'DrawerCash',
            },
        ),
        migrations.CreateModel(
            name='Sales',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_category', models.CharField(max_length=128, null=True, verbose_name='product_category')),
            ],
            options={
                'ordering': ['order'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('terminal_name', models.CharField(max_length=52, verbose_name='terminal name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('terminal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='history', to='sale.Terminal', verbose_name='order')),
            ],
            options={
                'ordering': ('date',),
                'verbose_name': 'Terminal history entry',
                'verbose_name_plural': 'Terminal history entries',
            },
        ),
    ]
