...
urlpatterns = [
		url(r'^$', permission_required('sales.view_sales_reports', login_url='not_found')
			(views.sales_reports), name='sales_reports'),
		url(r'^sales/$', permission_required('sales.view_sales_reports', login_url='not_found')
			(views.sales_list), name='sales_list'),
		url(r'^detail/(?P<pk>[0-9]+)/$', permission_required('sales.view_sales_reports', login_url='not_found')
			(views.sales_detail), name='sale-detail'),
		url(r'^product_reports/$',  permission_required('sales.view_products_reports', login_url='not_found')
		...
		url(r'^prd/$',  permission_required('sales.view_products_reports', login_url='not_found')
		...
		url(r'^purchases_reports/$',  permission_required('sales.view_purchase_reports', login_url='not_found')
			(views.purchases_reports), name='purchases_reports'),
		url(r'^balancesheet_reports/$', permission_required('sales.view_balancesheet', login_url='not_found')
		...
		url( r'^datechart/$',  permission_required('sales.view_sales_reports', login_url='not_found')
			(charts.sales_date_chart), name = 'sales_date_chart' ),
		url( r'^datechartimage/(?P<image>.+)/$', charts.sales_date_chart, name = 'sales_date_chart' ),
		url( r'^productchart/$',  permission_required('sales.view_products_reports', login_url='not_found')
		...
		url( r'^category/$',  permission_required('sales.view_sales_reports', login_url='not_found')
		...
		url( r'^userchart/$',  permission_required('sales.view_sales_reports', login_url='not_found')
			(charts.sales_user_chart), name = 'sales_user_chart' ),
		url( r'^utd/$', charts.get_user_sale_details, name = 'get_user_sale_details' ),
		url( r'^tellerchart/$',  permission_required('sales.view_sales_reports', login_url='not_found')
